...
class ValidateApplicant{
  public const MESSAGES_ERROR =[
    ...
    'applicant.postulante_numvecesu.required' => 'El campo número de veces que postula a la UNPRG es obligatorio',
    'applicant.postulante_numvecesu.numeric' => 'El campo número de veces que postula a la UNPRG debe ser un número',
    'applicant.postulante_numvecesu.integer' => 'El campo número de veces que postula a la UNPRG debe ser un número entero',
    'applicant.postulante_numvecesu.gte' => 'El campo número de veces que postula a la UNPRG debe ser mayor o igual a 0',
    'applicant.postulante_numveceso.required' => 'El campo número de veces que postula a otras universidades es obligatorio',
    'applicant.postulante_numveceso.numeric' => 'El campo número de veces que postula a otras universidades debe ser un número',
    'applicant.postulante_numveceso.integer' => 'El campo número de veces que postula a otras universidades debe ser un número entero',
    'applicant.postulante_numveceso.gte' => 'El campo número de veces que postula a otras universidades debe ser mayor o igual a 0',
