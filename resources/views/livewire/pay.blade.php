<div>
    <form action={{ route('pay.validatePayment') }} method="POST" class="mt-5">
        ...
        <label class="block mb-8">
            ...
            <input type="text" name="dni" wire:model="dni" minlength="8" maxlength="8" required
        ...
        <label class="block mb-8">
            ...
            <input type="text" name="voucherNumber" wire:model="voucherNumber" minlength="7" maxlength="7" required
                class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
