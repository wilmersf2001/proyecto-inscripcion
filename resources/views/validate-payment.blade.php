      ...
      <div>
        ...
        <div class="space-y-6">
          <p class="text-base text-gray-900 text-justify leading-7 px-8">
            ¡Bienvenido al proceso de admisión en la Universidad Pedro Ruiz Gallo! Para continuar, asegúrate de haber
            completado el pago correspondiente en el Banco de la Nación. Luego, ingresa tus datos a continuación para
