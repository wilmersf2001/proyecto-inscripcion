            ...
            <div class="mx-auto mt-5 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-10 lg:mx-0 lg:flex lg:max-w-none">
                <div class="p-8 sm:p-10 lg:flex-auto">
                    <div class="mt-4 flex items-center gap-x-4">
                        <h4 class="flex-none text-lg font-semibold leading-6 text-indigo-600">Consultar Ficha de
                            Inscripción
                        </h4>
                    ...
                    <ul role="list" class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:gap-6 list-disc">
                        <li class="flex gap-x-3">
                            <h5 class="text-sm font-bold text-gray-600">Antes recuerda que:</h5>
                        </li>
                        ...
                        <li class="text-gray-400"><span class="text-gray-600">La aprobación de las fotos o las observaciones
                                sobre las mismas se comunicarán a través de su correo electrónico.</span></li>
                    </ul>
                </div>
